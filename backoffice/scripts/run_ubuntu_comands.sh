...
#pg_restore -U postgres -Ft -v -d tfg-db tfg-db.sql
...
echo "  - Loading data for tests" && export PGPASSWORD=yourpassword && pg_restore -h localhost -p 5434 -U postgres -Ft -v -C -d tfg-db tfg-db.sql
